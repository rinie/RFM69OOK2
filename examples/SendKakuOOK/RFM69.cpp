...
#  ifdef RF_MODULE_INIT_STATUS
    	Serial.print (" SPI Config SCK: "), Serial.print (RF_MODULE_SCK),
    	Serial.print (" MISO: "), Serial.print(RF_MODULE_MISO),
    	Serial.print (" MOSI: "), Serial.print(RF_MODULE_MOSI),
    	Serial.print (" CS: "), Serial.print(RF_MODULE_CS);
    	Serial.print (" RF69_IRQ_PIN: "), Serial.print(RF69_IRQ_PIN);
    	Serial.print (" RF69_IRQ_NUM: "), Serial.println(RF69_IRQ_NUM);
#  endif
  SPI.begin(RF_MODULE_SCK, RF_MODULE_MISO, RF_MODULE_MOSI, RF_MODULE_CS);
#endif
  //SPI.begin();
